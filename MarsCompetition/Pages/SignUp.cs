    ...
    class SignUp
       {
        ...
        internal void register()
        {
            ...
            //Enter FirstName
            FirstName.SendKeys(GlobalDefinations.ExcelLib.ReadData(2, "FirstName"));

            //Enter LastName
            LastName.SendKeys(GlobalDefinations.ExcelLib.ReadData(2, "LastName"));

            //Enter Email
            Email.SendKeys(GlobalDefinations.ExcelLib.ReadData(2, "Email"));

            //Enter Password
            Password.SendKeys(GlobalDefinations.ExcelLib.ReadData(2, "Password"));

            //Enter Password again to confirm
            ConfirmPassword.SendKeys(GlobalDefinations.ExcelLib.ReadData(2, "ConfirmPswd"));
